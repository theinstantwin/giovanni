...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    ...
    <div class="wp-block-query">
        <!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|1"}}} -->
        <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|2","padding":{"top":"var:preset|spacing|2","right":"var:preset|spacing|3","bottom":"var:preset|spacing|2","left":"var:preset|spacing|3"}},"border":{"radius":"6px"}},"className":"blog-post-item","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
