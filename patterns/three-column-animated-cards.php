...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--24);padding-bottom:var(--wp--preset--spacing--32)">
	<!-- wp:heading {"align":"wide","level":2,"style":{"typography":{"letterSpacing":"0px","lineHeight":"0.8"},"elements":{"link":{"color":{"text":"var(--wp--preset--color--primary)"}}}},"className":"highlight","fontSize":"6xl"} -->
	<h2 class="wp-block-heading alignwide highlight has-link-color has-primary-color has-text-color has-6xl-font-size" style="letter-spacing:0px;line-height:.8">Our Featured Content</h2>
	<!-- /wp:heading -->

	<!-- wp:group {"align":"wide","layout":{"type":"grid","columnCount":3},"className":"hover-cards"} -->
	<div class="wp-block-group alignwide hover-cards">
		<!-- wp:group {"style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--8)","right":"var(--wp--preset--spacing--8)","bottom":"var(--wp--preset--spacing--8)","left":"var(--wp--preset--spacing--8)"}},"border":{"radius":"10px"},"position":{"type":"relative"}},"backgroundColor":"subtle","layout":{"type":"flex","orientation":"vertical","justifyContent":"left"},"className":"show-orb-on-hover is-linked","metadata":{"link":"#"},"fontSize":"md"} -->
		<div class="wp-block-group show-orb-on-hover is-linked has-subtle-background-color has-background has-md-font-size" style="border-radius:10px;padding-top:var(--wp--preset--spacing--8);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--8)">
			...
			<div class="wp-block-group is-content-justification-space-between is-nowrap is-layout-flex">
				...
				<p style="font-style:normal;font-weight:600">Podcast Episode 1</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-group show-orb-on-hover is-linked has-subtle-background-color has-background has-md-font-size" style="border-radius:10px;padding-top:var(--wp--preset--spacing--8);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--8)">
			...
			<div class="wp-block-group is-content-justification-space-between is-nowrap is-layout-flex">
				<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
				<p style="font-style:normal;font-weight:600">Interview with a Pro</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:paragraph {"fontSize":"sm"} -->
		...
		<div class="wp-block-group show-orb-on-hover is-linked has-subtle-background-color has-background has-md-font-size" style="border-radius:10px;padding-top:var(--wp--preset--spacing--8);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--8)">
			...
			<div class="wp-block-group is-content-justification-space-between is-nowrap is-layout-flex">
				<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
				<p style="font-style:normal;font-weight:600">Webinar: Design Systems</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:paragraph {"fontSize":"sm"} -->
