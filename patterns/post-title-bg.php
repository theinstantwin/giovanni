...
<!-- wp:group {"metadata":{"categories":["giovanni-posts"],"patternName":"giovanni-theme/post-title-bg","name":"Giovanni Post Title with Background"},"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--14)","bottom":"0px"},"blockGap":"var(--wp--preset--spacing--5)"}},"backgroundColor":"gray-900","textColor":"background","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull has-background-color has-gray-900-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--14);padding-bottom:0px"><!-- wp:post-terms {"term":"category","textAlign":"center","style":{"elements":{"link":{"color":{"text":"var(--wp--preset--color--giovanni-blue)"}}}},"fontSize":"sm"} /-->
...
<!-- wp:post-date {"style":{"color":{"text":"var(--wp--preset--color--gray-300)"}},"fontSize":"sm"} /--></div>
<!-- /wp:group -->
