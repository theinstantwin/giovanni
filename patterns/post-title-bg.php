...
<div class="wp-block-group alignfull has-background-color has-gray-900-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--14);padding-bottom:0px"><!-- wp:post-terms {"term":"category","textAlign":"center","style":{"elements":{"link":{"color":{"text":"var(--wp--preset--color--primary)"}}}},"fontSize":"sm"} /-->
