<?php
/**
 * Title: Blog Roll Cards Grid
 * Slug: giovanni/blog-roll-cards-grid
 * Categories: giovanni-cards
 * Description: A minimal grid of blog roll cards with simple lift hover effect.
 * Keywords: blog, roll, cards, grid, minimal
