...
<div class="wp-block-group margin-note-pattern">
    ...
    <div class="wp-block-group margin-note-container">
        ...
        <div class="wp-block-group margin-note-sidebar">
            ...
            <p class="margin-note-author has-gray-color has-text-color has-link-color" style="margin-top:0.5rem;margin-bottom:0;font-size:0.75rem;font-weight:500">— Author</p>
            <!-- /wp:paragraph -->
