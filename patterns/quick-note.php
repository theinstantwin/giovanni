...
<div class="wp-block-group margin-note-pattern">
    ...
    <div class="wp-block-group margin-note-container">
        ...
        <div class="wp-block-group margin-note-sidebar">
            ...
            <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var(--wp--preset--color--gray)"}}},"typography":{"fontSize":"0.75rem","fontWeight":"500"},"spacing":{"margin":{"top":"0.5rem","bottom":"0"}}},"textColor":"gray","className":"margin-note-author"} -->
