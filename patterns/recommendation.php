...
<div class="wp-block-group recommendation-pattern">
    <!-- wp:group {"style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--6)","bottom":"var(--wp--preset--spacing--6)","left":"var(--wp--preset--spacing--6)","right":"var(--wp--preset--spacing--6)"},"margin":{"top":"var(--wp--preset--spacing--8)","bottom":"var(--wp--preset--spacing--8)"},"blockGap":"var(--wp--preset--spacing--6)"},"border":{"radius":"var(--giovanni-card-radius)","width":"1px"}},"backgroundColor":"container","borderColor":"subtle-border","className":"recommendation-card","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
    <div class="wp-block-group recommendation-card has-container-background-color has-subtle-border-border-color has-background has-border-color" style="border-width:1px;border-radius:var(--giovanni-card-radius);margin-top:var(--wp--preset--spacing--8);margin-bottom:var(--wp--preset--spacing--8);padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
        ...
        <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--4);margin-bottom:var(--wp--preset--spacing--4)">
            ...
            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"},"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var(--wp--preset--color--secondary)"}}},"textColor":"secondary"},"className":"recommendation-meta","fontSize":"sm"} -->
            <p class="recommendation-meta has-secondary-color has-text-color has-link-color has-sm-font-size" style="margin-top:0;margin-bottom:0;line-height:1.5">Category or Type</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group">
            <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var(--wp--preset--color--secondary)"}}},"typography":{"fontWeight":"500"}},"textColor":"secondary","className":"recommendation-rating","fontSize":"sm"} -->
            <p class="recommendation-rating has-secondary-color has-text-color has-link-color has-sm-font-size" style="font-weight:500">My Rating:</p>
            <!-- /wp:paragraph -->
