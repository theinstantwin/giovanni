...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    <!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--4)","padding":{"bottom":"var(--wp--preset--spacing--8)"}},"border":{"bottom":{"color":"var(--wp--preset--color--subtle-border)","width":"2px"}}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--subtle-border);border-bottom-width:2px;padding-bottom:var(--wp--preset--spacing--8)">
    ...
    <div class="wp-block-query">
        ...
        <!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--5)","padding":{"top":"var(--wp--preset--spacing--6)","right":"var(--wp--preset--spacing--6)","bottom":"var(--wp--preset--spacing--6)","left":"var(--wp--preset--spacing--6)"}},"border":{"radius":"var(--giovanni-card-radius)","width":"1px"}},"backgroundColor":"container","borderColor":"subtle-border","layout":{"type":"constrained"}} -->
        <div class="wp-block-group has-container-background-color has-subtle-border-border-color has-background has-border-color" style="border-width:1px;border-radius:var(--giovanni-card-radius);padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
            ...
            <!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--4)","padding":{"top":"var(--wp--preset--spacing--4)"}},"border":{"top":{"color":"var(--wp--preset--color--subtle-border)","width":"1px"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
            <div class="wp-block-group" style="border-top-color:var(--wp--preset--color--subtle-border);border-top-width:1px;padding-top:var(--wp--preset--spacing--4)">
    ...
    <!-- wp:group {"style":{"spacing":{"margin":{"top":"var(--wp--preset--spacing--12)","bottom":"var(--wp--preset--spacing--8)"},"padding":{"top":"var(--wp--preset--spacing--6)","bottom":"var(--wp--preset--spacing--6)"}},"border":{"top":{"color":"var(--wp--preset--color--subtle-border)","width":"1px"}}},"layout":{"type":"flex","justifyContent":"center"}} -->
    <div class="wp-block-group" style="border-top-color:var(--wp--preset--color--subtle-border);border-top-width:1px;margin-top:var(--wp--preset--spacing--12);margin-bottom:var(--wp--preset--spacing--8);padding-top:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6)">
