...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    <!-- wp:heading {"textAlign":"center","style":{"typography":{"fontWeight":"600","lineHeight":"1.2","letterSpacing":"-0.015em"},"spacing":{"margin":{"bottom":"var:preset|spacing|12"}}},"fontSize":"2xl"} -->
    ...
    <div class="wp-block-query">
        <!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|8"}},"layout":{"type":"grid","columnCount":3}} -->
        <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|4","padding":{"top":"var:preset|spacing|6","right":"var:preset|spacing|6","bottom":"var:preset|spacing|6","left":"var:preset|spacing|6"}},"border":{"radius":"8px","color":"var:preset|color|gray-200","width":"1px"}},"backgroundColor":"white","layout":{"type":"constrained"}} -->
        <div class="wp-block-group has-white-background-color has-background" style="border-color:var(--wp--preset--color--gray-200);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
            <!-- wp:post-featured-image {"isLink":true,"style":{"border":{"radius":"6px"},"spacing":{"margin":{"bottom":"var:preset|spacing|4"}}}} /-->
            
            <!-- wp:post-terms {"term":"category","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|2"}}},"textColor":"gray-500","fontSize":"sm"} /-->
            
            <!-- wp:post-title {"isLink":true,"style":{"typography":{"fontWeight":"600","lineHeight":"1.3"},"spacing":{"margin":{"bottom":"var:preset|spacing|3"}}},"fontSize":"lg"} /-->
            
            <!-- wp:post-excerpt {"excerptLength":15,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|4"}}},"textColor":"gray-600","fontSize":"sm"} /-->
    ...
    <!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|12"}}},"layout":{"type":"flex","justifyContent":"center"}} -->
    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--12)">
        <!-- wp:buttons -->
        <div class="wp-block-buttons">
            <!-- wp:button {"textColor":"gray-600","style":{"color":{"background":"transparent"},"typography":{"fontWeight":"500"},"spacing":{"padding":{"left":"var:preset|spacing|8","right":"var:preset|spacing|8","top":"var:preset|spacing|3","bottom":"var:preset|spacing|3"}},"border":{"radius":"6px","color":"var:preset|color|gray-300","width":"1px"}},"fontSize":"md","className":"is-style-outline"} -->
