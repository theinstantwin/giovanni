...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    ...
    <div class="wp-block-query">
        ...
        <div class="wp-block-group has-white-background-color has-background" style="border-color:var(--wp--preset--color--light-gray);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
            ...
            <!-- wp:post-terms {"term":"category","style":{"spacing":{"margin":{"bottom":"var(--wp--preset--spacing--2)"}}},"textColor":"secondary","fontSize":"sm"} /-->
            ...
            <!-- wp:post-excerpt {"excerptLength":15,"style":{"spacing":{"margin":{"bottom":"var(--wp--preset--spacing--4)"}}},"textColor":"secondary","fontSize":"sm"} /-->
            ...
            <div class="wp-block-group">
                ...
                <!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"secondary","fontSize":"sm"} -->
                <p class="has-secondary-color has-text-color has-sm-font-size" style="margin-top:0;margin-bottom:0">2 min read</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <p class="has-text-align-center has-secondary-color has-text-color">No posts found to feature.</p>
        <!-- /wp:paragraph -->
        <!-- /wp:query-no-results -->
    </div>
    <!-- /wp:query -->
    ...
    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--12)">
        ...
        <div class="wp-block-buttons">
            <!-- wp:button {"textColor":"secondary","style":{"color":{"background":"transparent"},"typography":{"fontWeight":"500"},"spacing":{"padding":{"left":"var(--wp--preset--spacing--8)","right":"var(--wp--preset--spacing--8)","top":"var(--wp--preset--spacing--3)","bottom":"var(--wp--preset--spacing--3)"}},"border":{"radius":"6px","color":"var(--wp--preset--color--secondary)","width":"1px"}},"fontSize":"md","className":"is-style-outline"} -->
            <div class="wp-block-button has-md-font-size is-style-outline"><a class="wp-block-button__link has-secondary-color has-text-color wp-element-button" href="/" style="border-color:var(--wp--preset--color--secondary);border-width:1px;border-radius:6px;background:transparent;font-weight:500;padding-top:var(--wp--preset--spacing--3);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--3);padding-left:var(--wp--preset--spacing--8)">View all posts →</a></div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
    </div>
