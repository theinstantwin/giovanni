...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    ...
    <div class="wp-block-query">
        ...
        <!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--4)","padding":{"top":"var(--wp--preset--spacing--6)","right":"var(--wp--preset--spacing--6)","bottom":"var(--wp--preset--spacing--6)","left":"var(--wp--preset--spacing--6)"}},"border":{"radius":"8px","color":"var(--wp--preset--color--subtle-border)","width":"1px"}},"backgroundColor":"container","layout":{"type":"constrained"}} -->
        <div class="wp-block-group has-white-background-color has-background" style="border-color:var(--wp--preset--color--subtle-border);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6);padding-left:var(--wp--preset--spacing--6)">
            <!-- wp:post-featured-image {"isLink":true,"style":{"border":{"radius":"6px"},"spacing":{"margin":{"bottom":"var(--wp--preset--spacing--4)"}}}} /-->
            
            <!-- wp:post-terms {"term":"category","style":{"spacing":{"margin":{"bottom":"var(--wp--preset--spacing--2)"}}},"textColor":"muted-text","fontSize":"sm"} /-->
            ...
            <!-- wp:post-excerpt {"excerptLength":15,"style":{"spacing":{"margin":{"bottom":"var(--wp--preset--spacing--4)"}}},"textColor":"muted-text","fontSize":"sm"} /-->
            ...
            <div class="wp-block-group">
                ...
                <!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"muted-text","fontSize":"sm"} -->
                <p class="has-muted-text-color has-text-color has-sm-font-size" style="margin-top:0;margin-bottom:0">2 min read</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <p class="has-text-align-center has-muted-text-color has-text-color">No posts found to feature.</p>
        <!-- /wp:paragraph -->
        <!-- /wp:query-no-results -->
    </div>
    <!-- /wp:query -->
    ...
    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--12)">
        ...
        <div class="wp-block-buttons">
            <!-- wp:button {"textColor":"muted-text","style":{"color":{"background":"transparent"},"typography":{"fontWeight":"500"},"spacing":{"padding":{"left":"var(--wp--preset--spacing--8)","right":"var(--wp--preset--spacing--8)","top":"var(--wp--preset--spacing--3)","bottom":"var(--wp--preset--spacing--3)"}},"border":{"radius":"6px","color":"var(--wp--preset--color--muted-text)","width":"1px"}},"fontSize":"md","className":"is-style-outline"} -->
            <div class="wp-block-button has-md-font-size is-style-outline"><a class="wp-block-button__link has-muted-text-color has-text-color wp-element-button" href="/" style="border-color:var(--wp--preset--color--muted-text);border-width:1px;border-radius:6px;background:transparent;font-weight:500;padding-top:var(--wp--preset--spacing--3);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--3);padding-left:var(--wp--preset--spacing--8)">View all posts →</a></div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
    </div>
