...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    ...
    <div class="wp-block-query">
        ...
        <!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--4)","padding":{"top":"var(--wp--preset--spacing--6)","right":"var(--wp--preset--spacing--6)","bottom":"var(--wp--preset--spacing--6)","left":"var(--wp--preset--spacing--6)"}},"border":{"radius":"8px","color":"var(--wp--preset--color--light-gray)","width":"1px"}},"backgroundColor":"white","layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--12)">
        ...
        <div class="wp-block-buttons">
            <!-- wp:button {"textColor":"gray","style":{"color":{"background":"transparent"},"typography":{"fontWeight":"500"},"spacing":{"padding":{"left":"var(--wp--preset--spacing--8)","right":"var(--wp--preset--spacing--8)","top":"var(--wp--preset--spacing--3)","bottom":"var(--wp--preset--spacing--3)"}},"border":{"radius":"6px","color":"var(--wp--preset--color--gray)","width":"1px"}},"fontSize":"md","className":"is-style-outline"} -->
            <div class="wp-block-button has-md-font-size is-style-outline"><a class="wp-block-button__link has-gray-color has-text-color wp-element-button" href="/" style="border-color:var(--wp--preset--color--gray);border-width:1px;border-radius:6px;background:transparent;font-weight:500;padding-top:var(--wp--preset--spacing--3);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--3);padding-left:var(--wp--preset--spacing--8)">View all posts →</a></div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
    </div>
