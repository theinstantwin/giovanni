...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
    ...
    <div class="wp-block-query">
        ...
        <!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--5)","padding":{"top":"var(--wp--preset--spacing--8)","right":"var(--wp--preset--spacing--8)","bottom":"var(--wp--preset--spacing--8)","left":"var(--wp--preset--spacing--8)"}},"border":{"radius":"12px","color":"var(--wp--preset--color--light-gray)","width":"1px"},"elements":{"link":{"color":{"text":"var(--wp--preset--color--foreground)"}}},"dimensions":{"minHeight":"320px"}},"backgroundColor":"white","layout":{"type":"constrained"},"className":"hover-lift"} -->
        <div class="wp-block-group hover-lift has-white-background-color has-background has-link-color" style="border-color:var(--wp--preset--color--light-gray);border-width:1px;border-radius:12px;min-height:320px;padding-top:var(--wp--preset--spacing--8);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--8)">
