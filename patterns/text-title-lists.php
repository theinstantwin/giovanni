...
<!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--3)","padding":{"top":"0","right":"0px","bottom":"var(--wp--preset--spacing--12)","left":"0"}},"border":{"bottom":{"color":"var(--wp--preset--color--light-gray)","width":"1px"}}},"textColor":"secondary","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group has-secondary-color has-text-color" style="border-bottom-color:var(--wp--preset--color--light-gray);border-bottom-width:1px;padding-top:0;padding-right:0px;padding-bottom:var(--wp--preset--spacing--12);padding-left:0"><!-- wp:post-terms {"term":"category","textAlign":"center","separator":"  ","style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"600"}},"fontSize":"sm"} /-->
