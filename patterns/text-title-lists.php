...
<!-- wp:group {"style":{"spacing":{"blockGap":"var(--wp--preset--spacing--3)","padding":{"top":"0","right":"0px","bottom":"var(--wp--preset--spacing--12)","left":"0"}},"border":{"bottom":{"color":"var(--wp--preset--color--subtle-border)","width":"1px"}}},"textColor":"muted-text","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group has-muted-text-color has-text-color" style="border-bottom-color:var(--wp--preset--color--subtle-border);border-bottom-width:1px;padding-top:0;padding-right:0px;padding-bottom:var(--wp--preset--spacing--12);padding-left:0"><!-- wp:post-terms {"term":"category","textAlign":"center","separator":"  ","style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"600"}},"fontSize":"sm"} /-->
