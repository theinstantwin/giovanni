...
<!-- wp:paragraph {"textColor":"gray-300","fontSize":"sm"} -->
<p class="has-gray-300-color has-text-color has-sm-font-size">/</p>
<!-- /wp:paragraph -->

<!-- wp:post-date {"style":{"color":{"text":"var(--wp--preset--color--gray-200)"}},"fontSize":"sm"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->